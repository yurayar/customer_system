...
class AgreementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agreement" do
    assert_difference('Agreement.count') do
      post agreements_url, params: { agreement: { company_id: @agreement.company_id, number: @agreement.number } }
    end
  ...
  test "should update agreement" do
    patch agreement_url(@agreement), params: { agreement: { company_id: @agreement.company_id, number: @agreement.number } }
